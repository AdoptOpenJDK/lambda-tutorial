## Lambda Tutorial [![Build Status](https://api.travis-ci.org/AdoptOpenJDK/lambda-tutorial.png?branch=solutions-postjava8)](https://travis-ci.org/AdoptOpenJDK/lambda-tutorial)
